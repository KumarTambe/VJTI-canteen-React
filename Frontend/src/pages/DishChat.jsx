    ...
    return (
        <div className="min-h-screen bg-gray-950 text-white px-6 py-8">
            <div className="max-w-2xl mx-auto">
                ...
                <div className="bg-gray-900 rounded-2xl p-6 mb-6 min-h-96 flex-1 overflow-y-auto flex flex-col gap-3">
                    {messages.length === 0 ? (
                        ...
                        messages.map(message => (
                            <div key={message.id} className="bg-gray-800 rounded-xl px-4 py-3">
                                <span className="text-orange-400 font-semibold">{message.user_id}</span>
